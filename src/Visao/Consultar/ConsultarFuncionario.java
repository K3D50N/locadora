...
public class ConsultarFuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jTF_Cod, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    // End of variables declaration//GEN-END:variables
     ...
     private void BuscarNome() {
        ...
        FuncionarioDAO bd = new FuncionarioDAO(Con);
        List<Funcionario> lista = new ArrayList<>();
        lista = bd.Pesquisar_Nome_Funcionario(jTF_Nome.getText());
        DefaultTableModel tbm =
                (DefaultTableModel) tableFun.getModel();
        while (tbm.getRowCount() >0) {
            tbm.removeRow(0);
